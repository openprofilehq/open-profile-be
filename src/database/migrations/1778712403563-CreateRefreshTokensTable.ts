...
export class CreateRefreshTokensTable1778712403563 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."users_fullname_trgm_idx"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_reset_password_tokenSelector"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "waitList" DROP CONSTRAINT "UQ_c964d1d61359c1a9f8aa31eb0c2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "provider" character varying(32) NOT NULL DEFAULT 'local'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "users_fullname_trgm_idx" ON "users" ("full_name") `,
    );
  }
}
